...
color 0b
cls
title [B.M] 音声字幕抽出ツール（AAC + Sub）By. [B.M] 圓周率 3.14
...
if "%~1"=="" (
    powershell -NoProfile -ExecutionPolicy Bypass -File "%PS1%" -Language JP
    goto :AfterRun
)
...
:RunWithList
powershell -NoProfile -ExecutionPolicy Bypass -File "%PS1%" -Language JP -InputListFile "%INPUT_LIST%"
